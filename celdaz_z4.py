...
def m_vs_h_paramagneto_4(q,l,Hinicial,Hfinal,deltaH,J,mu,T,n):
  ...
  evolucionar_4(l,celda, celda_embebida, ensamble, ensamble_embebido,J,Hinicial,mu,T,n)
...
####################################################################################################
def energia_relajacion_4(q,p,l, J,H,mu,T,f):
  ...
  ensamble_embebido.append(celda_embebida)
  for j in range(0,f):
    energia_relajacion.append(evolucionar_4(l,ensamble[-1], ensamble_embebido[-1], ensamble, ensamble_embebido,J,H,mu,T,1)[0])
...
def histeresis_4(q,l,Binicial,Bfinal,deltab,J,mu,T,n):
  ...
  lenb = len(Bs)
  evolucionar_4(l,celda, celda_embebida, ensamble, ensamble_embebido,J,Binicial,mu,T,n)
  for b in Bs:
      energia_, magnetizacion_ = evolucionar_4(l,ensamble[-1], ensamble_embebido[-1], ensamble, ensamble_embebido,J,b,mu,T,n)
      energias.append(energia_)
      magnetizaciones.append(magnetizacion_)
...
l8 = int(np.sqrt(2*N))
simulaciones = [
    (0, l8, -300, 300, 0.01, 1, 0.5, 15, 1),  # q, l, Binicial, Bfinal, deltab, J, mu, T, n
    (0.5, l8, -300, 300,0.01, 1, 0.5, 15, 1),
    (0.8, l8, -300, 300, 0.01, 1, 0.5, 15, 1)
]
